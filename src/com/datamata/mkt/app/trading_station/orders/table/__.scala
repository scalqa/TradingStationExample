...
class Table extends Ui.Table[Row] with _1_Account with _2_Type with _3_Clear with _4_Lots with _5_Price with _6_Offset with _7_Transmit with _8_Expire with _9_Method:
  ...
  abstract class TheColumn[CV](label_ :String, width_ : Int, showBackground: Order => Boolean = \/)(using o: Opt[Ordering[CV]], i: Given.VoidTag[CV]) extends Column[CV](label_, width_)(using o)(using i):
    sortable  = false
    alignment = CENTER
