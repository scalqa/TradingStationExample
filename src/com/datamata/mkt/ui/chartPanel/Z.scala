package com.datamata; package mkt; package ui; package chartPanel; import Fx.*; import language.implicitConversions
...
object Z:
  ...
  class CandleNode extends Abstract.Group:
    ...
    private class Idx(isMain: Boolean) extends Fx.Shape.Line:
      styleClasses += Style.Class(isMain ? "mkt-candlestick-line" or "mkt-candlestick-line-open-close")
